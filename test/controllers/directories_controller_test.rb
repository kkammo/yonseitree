...
class DirectoriesControllerTest < ActionController::TestCase
  ...
  test "should create directory" do
    assert_difference('Directory.count') do
      post :create, directory: { directory_name: @directory.directory_name, is_terminal: @directory.is_terminal }
    end
  ...
  test "should update directory" do
    patch :update, id: @directory, directory: { directory_name: @directory.directory_name, is_terminal: @directory.is_terminal }
    assert_redirected_to directory_path(assigns(:directory))
  end
